package com.moochiking.spinnerimageview;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    private final String[] inputs = {"Pakistan", "Iran", "China", "India", "Thailand", "U.A.E", "Yemen", "Palestine",
            "America", "Australia", "Turkey", "England",
            "France", "Greece"};

    private final String[] names = {"deosai_land", "dudipatsar_lake","rama_lake"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> picture = new ArrayAdapter<String>(this , android.R.layout.simple_spinner_item , names);
        spinner2.setAdapter(picture);
    ...
    public void onClick(View v){
        ...
        if(id == R.id.btnSave){
            ...
            if(pos2 == 0) display.setImageResource(R.drawable.deosai_land);
            else if (pos2 == 1) display.setImageResource(R.drawable.dudipatsar_lake);
            else if (pos2 == 2) display.setImageResource(R.drawable.rama_lake);
